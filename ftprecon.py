...
HYDRA = "hydra -L /usr/share/wfuzz/wordlist/others/names.txt -P /usr/share/wfuzz/wordlist/others/common_pass.txt -f -o results/%s_ftphydra.txt -u %s -s %s ftp" % (ip_address, ip_address, port)
